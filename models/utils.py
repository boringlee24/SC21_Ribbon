...
def cli():
    ...
    parser.add_argument("--bkgd_id", type=str, default='0') # this is for background process id
    parser.add_argument("--num_col", type=str, default='1') # number of colocated jobs
    parser.add_argument("--node", type=str, default=None) # this is node to send TCP message to
    parser.add_argument("--split_id", type=str, default='0') # this is for batch split id
